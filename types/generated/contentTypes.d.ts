...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    email: Attribute.Email;
    phone: Attribute.String;
    totalOrderAmount: Attribute.BigInteger;
    userId: Attribute.Relation<
      'api::order.order',
      'manyToOne',
      'plugin::users-permissions.user'
    ...
    paymentStatus: Attribute.Enumeration<
      ['PAID', 'UNPAID', 'CANCELED', 'EXPIRED']
    > &
      Attribute.DefaultTo<'UNPAID'>;
    orderStatus: Attribute.Enumeration<
      ['ORDER_RECEIVED', 'PROCESSING', 'ON_DELIVERY', 'DELIVERED']
    > &
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ratings: Attribute.Relation<
      ...
      'api::rating.rating'
    >;
    totalSelling: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    ...
    type: Attribute.Enumeration<['Organic', 'Non-Organic']>;
    color: Attribute.String;
    additionalDescription: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSliderSlider extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    type: Attribute.Enumeration<['home']>;
    description: Attribute.String;
